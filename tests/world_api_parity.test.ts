...
//
// `IWorld` (src/world_api.ts:341-518, 158 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (158 / 41 / 117)
...
// The 158 members of `interface IWorld`, in interface order (world_api.ts:342-517).
// Partition: 41 `data` + 117 `method` (read-returning + command-void + 3 async).
