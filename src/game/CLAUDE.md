...
| `keyboard_turn_facing.ts` / `self_alpha_lead.ts` | pure online-feel math: local display-only TURN_SPEED integration for keyboard turns; the echo-driven adaptive self render lead |
