...
export const guideStrings = {
  ...
  deedsPage: {
    ...
    standingsNote:
      'The realms keep a running tally of Renown across every account. To see who stands where, open the Book of Deeds in game and turn to the Renown standings; they live there, not on the wiki.',
