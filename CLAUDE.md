...
- **Don't hand-edit generated files**, e.g. `src/render/assets/manifest.generated.ts`
  (regenerate via the build). For SFX playback tuning, edit the checked-in
  `scripts/sfx/sfx_gain_map.json` and `scripts/sfx/sfx_speed_map.json`, then
  regenerate `src/game/sfx_manifest.generated.ts`.
  `public/audio/sfx/runtime-pack.json` is generated by the same SFX manifest step.
